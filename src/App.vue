<template>
    <div id="app">
        <Header :updateStatus="updateStatus" :loading="updatingData" />
        ...
        <div class="last-update"><a :href="snapshotImageData" @click="viewSnapshot()" target="_blank">Ultima actualización</a>: <span>{{lastUpdateAgo()}}</span></div>
